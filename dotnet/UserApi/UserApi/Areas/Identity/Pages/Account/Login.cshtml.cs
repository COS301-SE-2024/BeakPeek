...
namespace UserApi.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<AppUser> signInManager, ILogger<LoginModel> logger, AuthHandler authHandler, UserManager<AppUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            _logger.LogInformation("-----------------------------we got somewhere we didn't want to in Login.cshtml.cs---------------------------------");
            return Page();
        }
    }
}
